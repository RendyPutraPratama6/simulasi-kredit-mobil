    ...
    <header class="bg-white border-b shadow-sm fixed w-full z-10">
        <div class="max-w-4xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between">
            <div class="flex items-center space-x-3">
                <img src="img/logo.png" class="h-10 w-10 rounded-full bg-gray-300" alt="Logo Perusahaan">
                <span class="text-lg font-bold text-gray-900">Bandai Kredit</span>
            </div>
            <nav class="flex space-x-6 mt-2 md:mt-0">
                <a href="#" class="text-red-600 font-bold hover:underline">Beranda</a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6" id="tentangperusahaan">
            <div class="bg-white p-6 rounded-lg border shadow-sm flex flex-col justify-center">
                ...
                <p class="text-gray-600 text-sm leading-relaxed">
                    Bandai Kredit adalah perusahaan pembiayaan mobil yang berdedikasi untuk membantu masyarakat memiliki mobil impian mereka dengan proses cepat, bunga ringan, dan angsuran yang transparan. Kami berkomitmen untuk memberikan layanan terbaik dan solusi keuangan yang sesuai dengan kebutuhan pelanggan.
                </p>
            </div>
            <div class="rounded-lg border overflow-hidden shadow-sm h-40 md:h-auto">
                <img src="img/bmw.png" class="w-full h-full object-cover" alt="Gambar Perusahaan">
            </div>
        </div>
                ...
                <form action="" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-4 items-center gap-2">
                        ...
                        <div class="sm:col-span-2 flex items-center space-x-2">
                            <select id="dp_persen" name="dp_persen" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500" required>
                            ...
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <label for="tenor<?= $i ?>" class="inline-flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" name="tenor" value="<?= $i ?>" id="tenor<?= $i ?>"
                                           class="tenor-checkbox rounded text-red-600 focus:ring-red-500 h-4 w-4"
        ...
        <div class="bg-white rounded-lg border border-gray-300 shadow-sm p-6 mb-6">
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-4 pt-2">
                    <span class="font-bold text-red-600 text-lg">Jumlah Angsuran</span>
                    <span class="sm:col-span-3 font-bold text-red-600 text-lg">: <?= formatRupiah($angsuran_per_bulan) ?> / Bulan</span>
                </div>
            </div>
        </div>
        <?php endif; ?>
